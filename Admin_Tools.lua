...
function r_smart_lib_imgui()
    if not pcall(function() imgui = require 'imgui' end) then
        ...
        if status then
          ...
          sampAddChatMessage(prefix.."������ Dear ImGui �������� ��������!", color)
          sampAddChatMessage(prefix.."���������� � ��������� ������� (vk.me/qrlk.mods), �������� ���� moonloader.log", color)
          print(err)
          for k, v in pairs(imguifiles) do
...
function imgui_init()
	...
	function imgui.OnDrawFrame()
		...
		if wInfo.spectatemenu and rInfo.id ~= -1 then
			...
			if result and doesCharExist(ped) then
				...
				if imgui.Button(u8'�� ���?') then
					sampSendChat(string.format("/ans %d �� ���? ����� � /b.", rInfo.id))
				end
				imgui.SameLine()
				
				if imgui.Button(u8'�� ��������') then
					sampSendChat(string.format("/ans %d �� ��������.", rInfo.id))
				end
		...
		if wInfo.main then 
			...
			if imgui.Button(u8'�������',imgui.ImVec2(310,25)) then
				wInfo.main = false
				wInfo.func = true
			elseif imgui.Button(u8'����������',imgui.ImVec2(310,25)) then 
				wInfo.main = false
				wInfo.stats = true
			elseif imgui.Button(u8'��������-����',imgui.ImVec2(310,25)) then 
				wInfo.func = false
		...
		elseif wInfo.stats then
			...
			imgui.SetNextWindowPos(imgui.ImVec2(ScreenX / 2, ScreenY / 2), imgui.Cond.FirstUseEver, imgui.ImVec2(0.5, 0.5))
			imgui.Begin(string.format(u8'���������� %s', sampGetPlayerNickname(playerid)), wInfo.main, imgui.WindowFlags.AlwaysAutoResize + imgui.WindowFlags.NoResize)

			imgui.Text(string.format(u8"������� ������: %s", secToTime(pInfo.session_time)))
			imgui.Text(string.format(u8"�������� ������ �� ����: %s", secToTime(mainIni.dayOnline.real)))
			imgui.Text(string.format(u8"��������� ������� � AFK: %s", secToTime(mainIni.dayOnline.afk)))

			imgui.Text(string.format(u8"������ ���������� ����: %d", mainIni.punishments.mute))
			imgui.Text(string.format(u8"�������� �������: %d", mainIni.punishments.jail))
			imgui.Text(string.format(u8"������� �������: %d", mainIni.punishments.kick))
		...
		elseif wInfo.info then
			...
			imgui.Begin(u8"���������� � �������", wInfo.info, imgui.WindowFlags.AlwaysAutoResize + imgui.WindowFlags.NoResize)
			if imgui.Button(u8'��������� � �������',imgui.ImVec2(310,25)) then
				os.execute('start https://vk.com/unknownus3r')
			end
			imgui.SetCursorPosX((imgui.GetWindowWidth() - 70) / 2)
			imgui.Text(u8'�����: taichi')
		...
		elseif wInfo.func then
			...
			if imgui.Checkbox(u8'���� �����', ckAutoLogin) then
			...
			if imgui.Checkbox(u8'���� /aduty', ckAutoAduty) then
			...
			if imgui.Checkbox(u8"�������� ����", ckTraicers) then 
			...
			if imgui.Button(u8'�����',imgui.ImVec2(490,25)) then
				wInfo.func = false
				wInfo.main = true
			end
		...
		elseif wInfo.teleport then
			...
			imgui.Begin(u8'�������� ����', wInfo.teleport, imgui.WindowFlags.AlwaysAutoResize + imgui.WindowFlags.NoResize)
...
function sampev.onServerMessage(color, text)
	...
	if text:find(sampGetPlayerNickname(playerid)) then
		if text:find("����� ������ ��") then return false
	...
	elseif text:find("��������, ��� ��") and ckAutoAduty then
